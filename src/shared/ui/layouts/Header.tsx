...
import { useDeviceWidth } from "../../lib/functions/useDeviceWidth";
...
export const Header = () => {
  ...
  return (
    <header className='fixed top-0 z-30 flex h-[48px] w-full items-center justify-between border-b-2 border-solid border-tetriaryBlack bg-mainWhite px-[22px] text-mainBlack lg:h-[68px] lg:px-[112px]'>
      ...
      {deviceWidth >= 1024 ? (
        <nav className='flex items-center gap-[204px]'>
          <div className='hidden gap-[64px] lg:flex'>
            ...
            <button className='flex items-center gap-2 text-16 font-medium' name='about'>
              About us
            </button>
          </div>
